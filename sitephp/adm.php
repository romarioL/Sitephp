...
<html>
   ...
   <div id="log-box">
        ...
        <a href="index.php" style="margin-left: 2%;">Início</a>||<a href="form-postar.php" style="margin-left: 2%;">Fazer postagem!</a> || <a href="form-scriptcss.php" style="margin-left: 2%;"> Criar scripts CSS</a>
