   ...
   <body>
    <div id="form-box">
      <h1 class="titulos" style="margin-left: 10%;">Postagens
       ...
       <div class="botoes">
         <a href="index.php" class="form-link">&larr; Voltar para a página inicial  </a>  <a href="form-scriptcss.php" class="form-link" style="margin-left: 20px;">   Form script CSS &rarr;</a>
      </div>
   </div>
   </body>
</html>
