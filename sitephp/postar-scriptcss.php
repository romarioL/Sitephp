...
$sql2 = mysqli_query($link, "INSERT INTO tb_postagens(titulo, imagem, texto, data, hr, page, id_user) VALUES('$titulo', '$foto', '$conteudo', '$data', '$hr', '$page', '$id_user') ");
echo $sql2;

   move_uploaded_file($_FILES['foto']['tmp_name'], $pasta."/".$foto);

   header('location: form-scriptcss.php');
